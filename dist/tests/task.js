...
describe("Service Company API", () => {
    ...
    describe("Route GET /api/company", () => {
        it("Should GET to /api/company", (done) => {
            chai
                .request(server)
                .get("/api/company")
                .end((err, res) => {
    ...
    describe("Route GET BY ID /api/company/:id", () => {
        ...
        it("Should GET to /api/compny/:id", (done) => {
            chai
                .request(server)
        ...
        it("Should NOT GET to /api/company/:id", (done) => {
            chai
                .request(server)
    ...
    describe("Route POST /api/company", () => {
        ...
        //     });
        // });
        it("Should NOT POST to /api/company because DUPLICATE COMPANY NAME", (done) => {
            chai
                .request(server)
                .post("/api/company")
                .set("content-type", "application/x-www-form-urlencoded")
        ...
        it("Should NOT POST to /api/company because Empty COMPANY NAME", (done) => {
            chai
                .request(server)
                .post("/api/company")
                .set("content-type", "application/x-www-form-urlencoded")
    ...
    describe("Route Update /api/company/:id", () => {
        it("Should Update to /api/company/:id", (done) => {
            chai
                .request(server)
        ...
        it("Should NOT Update to /api/company/:id because ID NOT FOUND", (done) => {
            chai
                .request(server)
    ...
    describe("Route Delete /company/:id", () => {
        it("Should DELETE to /api/company/:id", (done) => {
            chai
                .request(server)
        ...
        it("Should NOT DELETE to /api/company/:id because ID NOT FOUND", (done) => {
            chai
                .request(server)
